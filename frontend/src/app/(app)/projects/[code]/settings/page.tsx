...
import {
  ...
  useProjectAllowedTaskTypes,
  useSetProjectAllowedTaskTypes,
...
import { useTaskStates, useTaskTypes } from "@/queries/lookups";
...
function AllowedTaskTypesSection({ projectId }: { projectId: string }) {
  const t = useTranslations("ProjectSettings");
