...
namespace SoftimProject.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260629113539_MakeConnectionTemplateOptional")]
    partial class MakeConnectionTemplateOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftimProject.Domain.Entities.IntegrationConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("LastSyncWatermark")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ProjectSelectorJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<Guid?>("TargetProjectTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TargetProjectTemplateId");

                    b.HasIndex("SourceSystem", "IsEnabled");
            ...
            modelBuilder.Entity("SoftimProject.Domain.Entities.ProcessedWebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProcessedWebhookDeliveries", (string)null);
                });
            ...
            modelBuilder.Entity("SoftimProject.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasIndex("ExternalSystem", "ExternalProjectId")
                        .IsUnique()
                        .HasFilter("[ExternalProjectId] IS NOT NULL");
            ...
            modelBuilder.Entity("SoftimProject.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSyncedFromSourceAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SoftimProject.Domain.Entities.TicketWatcher", b =>
                {
                    b.Property<Guid>("TicketId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftimProject.Domain.Entities.IntegrationConnection", b =>
                {
                    b.HasOne("SoftimProject.Domain.Entities.Company", "TargetCompany")
                        .WithMany()
                        .HasForeignKey("TargetCompanyId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SoftimProject.Domain.Entities.ProjectTemplate", "TargetProjectTemplate")
                        .WithMany()
                        .HasForeignKey("TargetProjectTemplateId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("TargetCompany");

                    b.Navigation("TargetProjectTemplate");
                });
            ...
            modelBuilder.Entity("SoftimProject.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasOne("SoftimProject.Domain.Entities.IntegrationConnection", "IntegrationConnection")
                        .WithMany("Projects")
